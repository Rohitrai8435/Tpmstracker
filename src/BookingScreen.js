  ...
  const fetchData = async () => {
    try {
      ...
      if (parsedData.designation?.toLowerCase() == 'technician' ) {
        ...
        parsedData.designation?.toLowerCase() == 'soc team' ||
        parsedData.designation?.toLowerCase() == 'others') {
      ...
      if (response.status === 'success') {
        ...
        const incNotCloseList = data.filter(
          item =>
            item.service_type === 'Inc' && item.request_close_time === null,
        );
      ...
      Alert.alert(
        'Network Error',
        'An error occurred while fetching data. Please check your network connection.',
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <View style={styles.container}>
        <ScrollView
          ...
          <View style={styles.containers}>
            ...
            <Card
              svgSource={
                <CloseInc width={50} height={50} style={{borderRadius: 25}} />
              }
          ...
          {profile.designation === 'technician' && (
            <View style={styles.recommendedContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  navigation.navigate('IncService');
                }}>
