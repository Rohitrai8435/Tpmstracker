...
export const getImei = async () => {
  try {
    const response = await LocalApi.post('imei_list');
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const getDetailOfCard= async (unique_id,imei) => {
  try {
    const response = await LocalApi.post('detail_ofcard',{unique_id,imei});
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const pendingRemarkApi = async (unique_id, remark_soc,soc_id) => {
  try {
    const response = await LocalApi.post('pending_remark', { unique_id, remark_soc,soc_id });
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const hooter_on_off = async (imei,hooter_onoff) => {
  try {
    const response = await ApiService.post('hooter_on_off', { imei,hooter_onoff });
    return response?.data;
  } catch (error) {
    throw error;
  }
...
export const insert_Hooter_log = async (imei,aid,login_id,status) => {
  try {
    const response = await ApiService.post('insert_Hooter_log', { imei,aid,login_id,status });
    return response?.data;
  } catch (error) {
    throw error;
  }
...
export const getLogReport = async (imei, aid, ctm_id, s_date, e_date, usertype, client_version) => {
  try {
    const response = await ApiService.post('getAlarmLogByImei', { imei, aid, ctm_id, s_date, e_date, usertype, client_version });
    return response?.data;
  } catch (error) {
    throw error;
  }
...
export const getSiteRunningSource = async (aidv4, ctm_idv4, usertypev4, state_id, dist_id, cluster_id,aidv2, ctm_idv2, usertypev2) => {
  try {
    const response = await ApiService.post('new_siteRunningSource', {aidv4, ctm_idv4, usertypev4, state_id, dist_id, cluster_id,aidv2, ctm_idv2, usertypev2});
    return response?.data;
  } catch (error) {
    throw error;
  }
}
export const siteRunning = async (aidv4, ctm_idv4, usertypev4, state_id, dist_id, cluster_id,aidv2, ctm_idv2, usertypev2) => {
  try {
    const response = await ApiService.post('new_siteRunning', {aidv4, ctm_idv4, usertypev4, state_id, dist_id, cluster_id,aidv2, ctm_idv2, usertypev2});
    return response?.data;
  } catch (error) {
    throw error;
  }
...
export const getcurrentAlarmByImei = async (imei) => {
  try {
    const response = await ApiService.post('new_getcurrentAlarmByImeiV4',{ imei });
    return response?.data;
  } catch (error) {
    throw error;
  }
...
export const notification = async (aidv1,aidv2,aidv4,userv1,userv2,userv4,value) => {
  try {
    const response = await ApiService.post('noncom2hour', {aidv1,aidv2,aidv4,userv1,userv2,userv4,value});
    return response?.data;
  } catch (error) {
    throw error;
  }
